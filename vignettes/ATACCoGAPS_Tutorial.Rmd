...
repmis::source_data("https://github.com/FertigLab/ATACCoGAPS/blob/updateBranch/BuenrostroFinalSubsetData.Rdata?raw=true")

#getting GRanges for peaks
repmis::source_data("https://github.com/FertigLab/ATACCoGAPS/blob/updateBranch/BuenrostroGRanges.Rdata?raw=true")

#getting celltypes
repmis::source_data("https://github.com/FertigLab/ATACCoGAPS/blob/updateBranch/BuenrostroCellTypes.Rdata?raw=true")
```
